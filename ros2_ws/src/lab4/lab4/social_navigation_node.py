...
class SocialNavigationNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('start', [0.19534456729888916, -0.8630493879318237, -0.001434326171875])
        self.declare_parameter('mid',   [0.7555080056190491, -1.2688796520233154, -0.001434326171875])
        self.declare_parameter('final', [1.2500518560409546, -1.76183712482524, 0.006378173828125])
